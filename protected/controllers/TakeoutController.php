...
class TakeoutController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Takeout'];
			if($model->save())
	...
	{
		$model=new Takeout('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Takeout']))
			$model->attributes=$_GET['Takeout'];
	...
	{
		$model=Takeout::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='takeout-form')
		{
